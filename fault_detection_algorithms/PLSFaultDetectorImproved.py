...
@dataclass
class PLSFaultDetectorImprovedParameters:
    n_latent: float = 6
    alpha: float = 0.99
...
class PLSFaultDetectorImproved(BaseFaultDetectionAlgorithm):
    ...
    def __init__(self, params=PLSFaultDetectorImprovedParameters()):
        """
        Parameters
        ----------
        n_latent : int
        ...
        self.use_percentiles = params.use_percentiles
    ...
    def train(self, X_train, Y_train):
        ...
        # self.roc_parametrers_range(conf_lvls= [self.alpha])[0]
        self.SPE_threshold_, self.T2_threshold_ = SPE_threshold_, T2_threshold_
